    ...
    begin
      ...
      config_prod.each do |key, value|
        if key == "defaults"
          ...
          value[4].each do |key, value| # collections.emergency-lights.published = false
            key == "values" ? value.merge!({ "published" => false }) : nil
          end
          value[5].each do |key, value| # collections.auxiliary-equipment.published = false
            key == "values" ? value.merge!({ "published" => false }) : nil
          end
          value[6].each do |key, value| # collections.satelital.published = false
            key == "values" ? value.merge!({ "published" => false }) : nil
          end
          value[7].each do |key, value| # collections.gps.published = false
            key == "values" ? value.merge!({ "published" => false }) : nil
          end
          value[8].each do |key, value| # collections.spares.published = false
            key == "values" ? value.merge!({ "published" => false }) : nil
          end
          value[9].each do |key, value| # collections.networks.published = false
            key == "values" ? value.merge!({ "published" => false }) : nil
          end
        end
      end
